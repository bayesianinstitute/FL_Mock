...
class XGBoostTabularClassification:
    def __init__(self, ip="http://localhost", port=5000, experiment_name='xgboost_classification_experiment'):
...
if __name__ == '__main__':
    # Example usage:
    xgboost_classification_model = XGBoostTabularClassification()
    xgboost_classification_model.train_model()
    xgboost_classification_model.save_model("xgboost_model.json")
